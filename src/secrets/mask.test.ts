...
const sampleSecret = "sk-proj-not-a-real-key-abc123def456ghi789jkl012mno345pqr678stu901vwx";
const stripeSecret = "sk-safe-liveprefix-REDACTED_NOT_A_REAL_KEY";
...
describe("secrets placeholder format", () => {
  ...
  test("increments counter per secret type", () => {
    const anotherSecret = "sk-proj-not-a-real-key-xyz789abc123def456ghi789jkl012mno345pqr678";
  ...
  test("tracks different secret types separately", () => {
    const awsKey = "AKIA00FAKENOTREAL000XX";
